<template>
	<view class="content">
		...
		<view class="links">
            			            <view class="link-highlight" @tap="onRegisterTap('wailairenkou')" :style='{"color":"rgba(204, 204, 0, 1)","fontSize":"24rpx"}'>注册外来人口</view>
            <view>|</view>
                        			            <view class="link-highlight" @tap="onRegisterTap('paichusuo')" :style='{"color":"rgba(204, 204, 0, 1)","fontSize":"24rpx"}'>注册派出所</view>
            <view>|</view>
