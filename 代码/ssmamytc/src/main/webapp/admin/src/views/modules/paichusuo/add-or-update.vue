  ...
  <div class="addEdit-block">
    ...
    >
      <el-row>
          ...
          <el-form-item class="input" label="密码" prop="mima">
              <el-input v-model="ruleForm.mima" 
                placeholder="密码" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="派出所名称" prop="paichusuomingcheng">
          <el-input v-model="ruleForm.paichusuomingcheng" 
              placeholder="派出所名称" clearable  :readonly="ro.paichusuomingcheng"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="派出所名称" prop="paichusuomingcheng">
              <el-input v-model="ruleForm.paichusuomingcheng" 
                placeholder="派出所名称" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
          ...
          <el-form-item class="input" label="地址" prop="dizhi">
              <el-input v-model="ruleForm.dizhi" 
                placeholder="地址" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="网址" prop="wangzhi">
          <el-input v-model="ruleForm.wangzhi" 
              placeholder="网址" clearable  :readonly="ro.wangzhi"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="网址" prop="wangzhi">
              <el-input v-model="ruleForm.wangzhi" 
        ...
        <div v-else>
          <el-form-item class="input" label="服务时间" prop="fuwushijian">
              <el-input v-model="ruleForm.fuwushijian" 
                placeholder="服务时间" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                              </el-row>
...
export default {
  ...
  methods: {
    ...
    onSubmit() {
        ...
        if (valid) {
          this.$http({
            url: `paichusuo/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.paichusuoCrossAddOrUpdateFlag = false;
                  this.parent.search();
